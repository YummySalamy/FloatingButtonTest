    ...
    return (
        <div>
            ...
            <ChatContainer isOpen={isChatVisible}>
                {isChatVisible ? (
                // Mostrar el chat con encabezado
                <>
                    <ChatHeader>
                    <h2>AI-CHAIN</h2> {/* Aquí puedes personalizar el encabezado con el nombre de tu empresa */}
                    </ChatHeader>
                    <ChatInterface chatData={chatData} onSendMessage={handleSendMessage} />
                </>
                ) : (
                // Mostrar el texto predeterminado sin encabezado
